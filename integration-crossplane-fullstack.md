---
url: 'https://lynq.sh/integration-crossplane-fullstack.md'
description: >-
  Production full-stack Crossplane + Lynq walkthrough: RDS database, S3 bucket,
  CloudFront CDN, and Kubernetes workloads provisioned per node.
---
