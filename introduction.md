---
url: 'https://lynq.sh/introduction.md'
description: >-
  What Lynq is and why it exists — database-driven Kubernetes infrastructure,
  the three CRDs (LynqHub, LynqForm, LynqNode), and when to use it.
---
