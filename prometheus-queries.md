---
url: 'https://lynq.sh/prometheus-queries.md'
description: >-
  Production-ready Prometheus query examples for Lynq: health, performance,
  conflicts, rollouts, and hub metrics.
---
...
All metrics are exposed at `:8443/metrics`. See [Monitoring](monitoring.md) for setup and the full metrics catalog.
