---
url: 'https://lynq.sh/roadmap.md'
description: >-
  Lynq roadmap: completed milestones in v1.0–v1.1, planned features for v1.2
  (PostgreSQL, enhanced observability) and v1.3 (node sharding, advanced
  multi-tenancy) and beyond.
---
