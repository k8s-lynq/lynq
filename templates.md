---
url: 'https://lynq.sh/templates.md'
description: >-
  Master Lynq's template system powered by Go text/template and 200+ Sprig
  functions. Learn template syntax, custom functions, variables, and best
  practices.
---
