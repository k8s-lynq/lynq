---
url: 'https://lynq.sh/use-case-preview-environments.md'
description: >-
  Per-PR preview environments provisioned from CI with a single SQL INSERT. The
  row exists while the PR is open; deleting it cleans up every resource.
---
