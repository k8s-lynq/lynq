---
url: 'https://lynq.sh/contributing-datasource.md'
description: >-
  Guide for implementing a new datasource adapter for Lynq. Covers the
  Datasource interface, factory registration, API types, and testing.
---
