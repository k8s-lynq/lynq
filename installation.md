---
url: 'https://lynq.sh/installation.md'
description: >-
  Install Lynq on a Kubernetes cluster using Helm (recommended), Kustomize, or
  from source. Covers cert-manager setup, verification, and upgrades.
---
