---
url: 'https://lynq.sh/integration-flux.md'
description: >-
  Use Lynq with Flux for GitOps-style node provisioning. Manage GitRepositories
  and Kustomizations per node from database records.
---
