---
description: "Type conversion in Lynq templates: use int, float, and bool functions to produce correctly-typed values for Kubernetes resource fields."
---

# Template Type Conversion

<Badge type="tip" text="^1.1.15" />
