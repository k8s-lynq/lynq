---
url: 'https://lynq.sh/monitoring.md'
description: >-
  Set up Prometheus metrics, Grafana dashboards, and structured logging for
  Lynq. Includes metrics catalog, events reference, and alerting overview.
---
