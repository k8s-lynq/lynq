---
url: 'https://lynq.sh/advanced-use-cases.md'
description: >-
  Real-world Lynq patterns: custom domains, blue-green deployments, multi-tier
  stacks, database-per-node, feature flags, and preview environments.
---
