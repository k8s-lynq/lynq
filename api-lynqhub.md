---
url: 'https://lynq.sh/api-lynqhub.md'
description: >-
  LynqHub CRD API reference — spec.source MySQL connection, syncInterval,
  valueMappings, status fields, and multi-template support.
---
