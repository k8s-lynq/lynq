---
url: 'https://lynq.sh/use-case-feature-flags.md'
description: >-
  Database boolean columns as infrastructure switches — flip a column to
  provision or remove Kubernetes resources per node.
---
