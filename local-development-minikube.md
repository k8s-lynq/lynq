---
url: 'https://lynq.sh/local-development-minikube.md'
description: >-
  Set up a local Lynq development environment on Minikube with cert-manager,
  webhooks, and a sample MySQL datasource.
---
