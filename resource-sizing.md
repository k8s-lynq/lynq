---
url: 'https://lynq.sh/resource-sizing.md'
description: >-
  Right-size the Lynq controller pod with real observed data — sub-100m CPU and
  sub-120MB memory at 300+ LynqNodes — and understand why resources scale the
  way they do.
---
