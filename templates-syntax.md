---
url: 'https://lynq.sh/templates-syntax.md'
description: >-
  Template syntax reference for Lynq: available variables, custom functions
  (toHost, trunc63, sha1sum, fromJson), Sprig library, and advanced techniques.
---
