---
url: 'https://lynq.sh/dependencies.md'
description: >-
  Define resource ordering with dependency graphs in Lynq. Learn about DAG-based
  topological sorting, cycle detection, and the interactive dependency
  visualizer.
---
