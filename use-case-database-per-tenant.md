---
url: 'https://lynq.sh/use-case-database-per-tenant.md'
description: >-
  Provision a dedicated cloud database (RDS, Cloud SQL) per node using Lynq and
  Crossplane, driven by a database row.
---
