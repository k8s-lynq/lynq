---
url: 'https://lynq.sh/template-builder.md'
description: >-
  Interactive LynqForm builder — compose resource templates visually, configure
  dependencies and policies, and export ready-to-apply YAML.
---
