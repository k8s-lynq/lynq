---
url: 'https://lynq.sh/security.md'
description: >-
  Security hardening for Lynq: credential management with SecretRef, RBAC
  least-privilege roles, audit logging, and namespace isolation practices.
---
