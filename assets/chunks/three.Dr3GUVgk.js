...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ir(){return new an({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:rr(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Nr(){return new an({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:rr(),fragmentShader:`
...
`].filter(Tn).join(`
`)),o=Qi(o),o=Wr(o,t),o=Xr(o,t),a=Qi(a),a=Wr(a,t),a=Xr(a,t),o=qr(o),a=qr(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(M=`#version 300 es
