import{_ as n,c as a,o as e,a as p}from"./chunks/plugin-vue_export-helper.dqZ0aIgD.js";const b=JSON.parse('{"title":"Prometheus Query Examples","description":"Production-ready Prometheus query examples for Lynq: health, performance, conflicts, rollouts, and hub metrics.","frontmatter":{"description":"Production-ready Prometheus query examples for Lynq: health, performance, conflicts, rollouts, and hub metrics."},"headers":[],"relativePath":"prometheus-queries.md","filePath":"prometheus-queries.md","lastUpdated":1778722595000}'),l={name:"prometheus-queries.md"};function r(i,s,c,o,t,d){return e(),a("div",null,[...s[0]||(s[0]=[p(`<h1 id="prometheus-query-examples" tabindex="-1">Prometheus Query Examples <a class="header-anchor" href="#prometheus-query-examples" aria-label="Permalink to &quot;Prometheus Query Examples&quot;">​</a></h1><p>Ready-to-use PromQL queries for Lynq — node health, reconciliation performance, conflict detection, rollout progress, and hub-level aggregates.</p><p>All metrics are exposed at <code>:8443/metrics</code>. See <a href="./monitoring.html">Monitoring</a> for setup and the full metrics catalog.</p><h2 id="node-health" tabindex="-1">Node Health <a class="header-anchor" href="#node-health" aria-label="Permalink to &quot;Node Health&quot;">​</a></h2><h3 id="check-ready-nodes" tabindex="-1">Check Ready Nodes <a class="header-anchor" href="#check-ready-nodes" aria-label="Permalink to &quot;Check Ready Nodes&quot;">​</a></h3><div class="language-promql line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">promql</span><pre class="shiki github-dark vp-code" tabindex="0"><code><span class="line"><span># All ready nodes</span></span>
