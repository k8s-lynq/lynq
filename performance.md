---
url: 'https://lynq.sh/performance.md'
description: >-
  Tuning guide for Lynq at scale. Covers concurrency flags, requeue intervals,
  watch predicates, and large node count recommendations.
---
