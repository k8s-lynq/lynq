---
url: 'https://lynq.sh/datasource.md'
description: >-
  Connect Lynq to a MySQL database. Configure LynqHub with host, credentials,
  value mappings, and extraValueMappings for template variables.
---
