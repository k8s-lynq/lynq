const ko = {
  ...
  drawer: {
    ...
    conflictedResources: "충돌 리소스",
    managedInfo: "현재 템플릿의 리소스",
    skippedInfo: "의존성 실패만 해당",
    conflictedInfo: "소유권 충돌로 차단된 리소스",
    conflictedColon: "충돌됨:",
    noResources: "이 노드에 대한 리소스가 없습니다.",
    conflictDetectedTitle: "리소스 충돌 감지됨",
    conflictDetectedDesc: "충돌 리소스로 이동하려면 클릭하세요",
    conflictPolicy: "{{policy}} 충돌",
    conflictPolicyTooltip: "{{policy}} 정책으로 인한 소유권 충돌 — 리소스 차단됨",
    lastSeen: "마지막 확인",
