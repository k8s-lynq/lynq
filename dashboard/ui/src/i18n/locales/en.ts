const en = {
  ...
  drawer: {
    ...
    conflictedResources: "Conflicted Resources",
    managedInfo: "Resources in current template",
    skippedInfo: "Dependency failure only",
    conflictedInfo: "Resources blocked by ownership conflict",
    conflictedColon: "Conflicted:",
    noResources: "No resources found for this node.",
    conflictDetectedTitle: "Resource Conflicts Detected",
    conflictDetectedDesc: "Click to jump to conflicting resources",
    conflictPolicy: "{{policy}} Conflict",
    conflictPolicyTooltip: "Ownership conflict with {{policy}} policy — resource blocked",
    lastSeen: "Last seen",
