---
url: 'https://lynq.sh/configuration.md'
description: >-
  Lynq operator configuration reference: controller runtime flags, concurrency
  knobs (node, hub, form), requeue intervals, and feature gates.
---
