---
url: 'https://lynq.sh/api-lynqform.md'
description: >-
  LynqForm CRD API reference — hubId, resource arrays, TResource spec fields,
  dependency ordering, creationPolicy, and deletionPolicy.
---
